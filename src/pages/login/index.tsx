...
export default function AdminLoginPage() {
  ...
  return (
    <Layout hero={true} heroText="Login">
      <Head>
        <title>Login | The Backdrop</title>
      </Head>
      <div className="layout-wrapper">
        <form className="login-form">
          ...
          />
          {error && (
            <p className="error">You must supply a username and password.</p>
          )}
          {loginError && (
            <p className="error">
              Something went wrong with your login. If you are having trouble
              logging in, please contact the webmaster.
            </p>
          )}

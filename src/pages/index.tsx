...
const HomePage: NextPage = () => {
  return (
    <Layout>
      <Head>
        <title>
          A Creative Place Where You Can Be Your SELFIE. | The Backdrop
        </title>
        <meta
          name="description"
          content="  
              The Backdrop is a creative space where you can take the perfect
              selfie. We offer several photo spaces that are filled with
              professional ring lighting to perfect your images. 
        "
        />
      </Head>
      <InitialView />
      <section className="layout-wrapper">
        ...
        <div className="home-content reverse">
          <div>
            ...
            <p>
              View some of the creative photos that our clients have made in our
              photo spaces.
            </p>
